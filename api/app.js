...
/*		var test = traverse(req.body).reduce(function (acc, node){
		...
		var mailOptions = {
		    from: 'training@martinandassoc.com', // sender address
		    to: req.body.email+',training@martinandassoc.com', // list of receivers
		    subject: req.body.selectedClass.Class+' Training - Martin and Associates', // Subject line
