...
<body>
   <div class="text-center">
    ...
    <div class="row">
        <div class="col-lg-6">
            <ul class="confirm-list">
                <li><label>Name:&nbsp;</label>'+req.body.name+'</li>
                <li><label>Company:&nbsp;</label>'+req.body.company+'</li>
                <li><label>Email:&nbsp;</label>'+req.body.email+'</li>
                <li><label>Phone #:&nbsp;</label>'+req.body.phoneno+'</li>
            </ul>
        </div>
        <div class="col-lg-6">
            <ul class="confirm-list">
                <li><label>Address:&nbsp;</label>'+req.body.address+'</li>
                <li><label>State:&nbsp;</label>'+req.body.state+'</li>
                <li><label>City:&nbsp;</label>'+req.body.city+'</li>
                <li><label>Zipcode:&nbsp;</label>'+req.body.zipcode+'</li>
            </ul>
        </div>
    </div>
    <hr>
    <div class="row">
        <div class="col-lg-12">
            <ul class="confirm-list">
                <li><label>Class:&nbsp;</label>'+req.body.slectedClass.Class+'</li>
                <li><label>Start Date:&nbsp;</label>'+req.body.selectedDateTime.StartDate+'</li>
                <li><label>End Date:&nbsp;</label>'+req.body.selectedDateTime.EndDate+'</li>
            </ul>
        </div>
    </div>
    <hr>
